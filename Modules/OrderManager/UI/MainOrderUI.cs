namespace MiniStore.Modules.OrderManager.UI
{
    ...
    /// <summary>
    /// Defines the <see cref="MainOrderUI" />
    /// </summary>
    public partial class MainOrderUI : UserControl
    {
        ...
        private void SetupLayout()
        {
            ...
            orderFilter.BorderStyle = BorderStyle.None;
            orderFilter.Dock = DockStyle.Top;
            orderFilter.Height = 60;
            orderFilter.Margin = new Padding(0);
            ...
            this.splitContainer1.Panel2.Controls.Add(orderFilter);
